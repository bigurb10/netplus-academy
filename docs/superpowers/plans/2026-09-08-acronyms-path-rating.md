...
- Network+ answer keys balanced 2026-09-08 at Blake's OK ("we will want to mix up the answers for sure"): `tests/balance-keys.js` on all seven `courses/netplus/questions-N.js` files took the key positions from 57/242/62/6 to 88/92/94/93; four explanations under 40 characters (u4l1-6, u5l2-4, u5l2-8, u5l2-9) were lengthened so packcheck passes clean.
